...
-- Selecting Location, date, total_cases, new_cases, total_deaths, population as the Data that we are going to be starting with
...
-- Exploring the Countries with Highest Infection Rate compared to Population
...
-- Exploring the Countries with Highest Death Count per Population
...
-- Breaking data by the continents and showing the contintents with the highest death count per population
